...
python -u -c "import PyHipp as pyh; \
	...
	DPT.objects.processDirs(dirs=['sessioneye/array03','session01/array03'], cmd='import PyHipp as pyh; \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:736820347586:awsnotify --message "RS3JobDone"
