...
python -u -c "import PyHipp as pyh; \
	...
	DPT.objects.processDirs(dirs=['sessioneye/array02','session01/array02'], cmd='import PyHipp as pyh; \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:736820347586:awsnotify --message "RS2JobDone"
