...
python -u -c "import PyHipp as pyh; \
	...
	DPT.objects.processDirs(dirs=['sessioneye/array04','session01/array04'], cmd='import PyHipp as pyh; \
	import DataProcessingTools as DPT; DPT.objects.processDirs(None, pyh.RPLLFP, saveLevel=1); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:736820347586:awsnotify --message "RS4JobDone"
